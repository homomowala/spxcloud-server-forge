      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-blue-400">Ways to Reach Us</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="bg-gray-800 border-gray-700 text-center hover:border-blue-400 transition-colors">
        ...
        <section className="py-20 px-4 bg-gray-800/50">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-blue-400">How to Order</h2>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-blue-400">Frequently Asked Questions</h2>
            <div className="max-w-3xl mx-auto space-y-6">
              {faqItems.map((item, index) => (
                <Card key={index} className="bg-gray-800 border-gray-700">
                  <CardHeader>
                    <CardTitle className="text-xl text-blue-400">{item.question}</CardTitle>
                  </CardHeader>
                  <CardContent>
