      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="py-20 px-4 bg-gray-800/50">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-blue-400">Choose Your VPS Plan</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {plans.map((plan) => (
                <Card key={plan.name} className="bg-gray-800 border-gray-700 hover:border-blue-400 transition-all duration-300 hover:scale-105">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span>SSD:</span>
                      <span className="text-blue-400">{plan.ssd}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Bandwidth:</span>
                      <span className="text-blue-400">{plan.bandwidth}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Location:</span>
                      <span className="text-blue-400">{plan.location} 🇫🇷</span>
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-blue-400">Included with VPS</h2>
